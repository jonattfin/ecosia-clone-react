    ...
    <Grid container spacing={2}>
      <Grid item xs={12} xl={12}>
        <DivContainer>
          ...
          <Separator />
          <div>We use the profit we make from your searches to plant trees where they are needed most. </div>
          <div>Get the free browser extension and plant trees with every search.</div>
          <Separator />
          <div>
